...
class CaptionModel(nn.Module):
    def __init__(self, temperature, beam_size, group_size, decoding_constraint, diversity_lambda, suppress_UNK, length_penalty):
    ...
    def beam_search(self, init_state, init_logprobs, device: bool=None, *args, **kwargs):
