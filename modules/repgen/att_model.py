...
from modules.repgen.utils import *
from modules.repgen.caption_model import CaptionModel
...
class AttModel(CaptionModel):
    def __init__(self, 
                ...
                suppress_UNK, 
                length_penalty):
        super(AttModel, self).__init__(temperature, beam_size, group_size, decoding_constraint, diversity_lambda, suppress_UNK, length_penalty)
        ...
        self.bos_idx = vocab.index('xxbos')
        self.eos_idx = vocab.index('xxeos')
        self.pad_idx = vocab.index('xxpad')
        ...
        self.output_logsoftmax = output_logsoftmax
        self.decoding_constraint = decoding_constraint
        self.block_trigrams = block_trigrams
    ...
    def _sample_beam(self, fc_feats, att_feats, att_masks=None):
        ...
        self.done_beams = self.beam_search(state, logprobs, True, p_fc_feats, p_att_feats, pp_att_feats, p_att_masks)
